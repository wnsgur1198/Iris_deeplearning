...
# 임의의 아이리스 품종 예측
print("---아이리스의 속성 4개를 입력하시오---")
newIris_sepalLength = input("꽃받침길이: ")
newIris_sepalWidth = input("꽃받침넓이: ")
newIris_petalLength = input("꽃잎길이: ")
newIris_petalWidth = input("꽃잎넓이: ")

new_data = [float(newIris_sepalLength), float(newIris_sepalWidth), float(newIris_petalLength), float(newIris_petalWidth)]
print(new_data)
